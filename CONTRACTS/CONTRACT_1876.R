...
## GET RULES
rule_1876 <- range_read("1EypljfSPRP2FXIQuhK_b2lULM1v13RT3G-jeVVN4Mls",sheet = "PARAM1")

## SET RULES
trat_qtd_1876 <- rule_1876 %>% mutate(A=result_1876 %>% summarize(v=sum(VRVENDA))) %>% 
